...
func TestExcludeResource(t *testing.T) {
	...
	assert.True(t, FilteredResource{APIGroups: []string{apiGroup}, Kinds: []string{kind}, Clusters: []string{cluster}, Labels: []map[string]string{{"qux": "*"}}}.Match(apiGroup, kind, cluster, label))
	...
	assert.False(t, FilteredResource{APIGroups: []string{apiGroup}, Kinds: []string{kind}, Clusters: []string{""}, Labels: []map[string]string{{"qux": ""}}}.Match(apiGroup, kind, cluster, label))
	...
	assert.True(t, FilteredResource{APIGroups: []string{apiGroup}, Kinds: []string{kind}, Clusters: []string{cluster}, Labels: []map[string]string{label, label}}.Match(apiGroup, kind, cluster, label))

	// rubbish patterns
	assert.False(t, FilteredResource{APIGroups: []string{"["}, Kinds: []string{""}, Clusters: []string{""}, Labels: []map[string]string{{"qux": ""}}}.Match("", "", "", map[string]string{}))
	assert.False(t, FilteredResource{APIGroups: []string{""}, Kinds: []string{"["}, Clusters: []string{""}, Labels: []map[string]string{{"qux": ""}}}.Match("", "", "", map[string]string{}))
	assert.False(t, FilteredResource{APIGroups: []string{""}, Kinds: []string{""}, Clusters: []string{"["}, Labels: []map[string]string{{"qux": ""}}}.Match("", "", "", map[string]string{}))
	assert.False(t, FilteredResource{APIGroups: []string{""}, Kinds: []string{""}, Clusters: []string{""}, Labels: []map[string]string{{"qux": "["}}}.Match("", "", "", map[string]string{}))
}
